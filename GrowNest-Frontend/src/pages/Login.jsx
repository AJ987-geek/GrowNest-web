...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden bg-gradient-to-br from-primary-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      {/* Decorative circles */}
      <div className="absolute -bottom-20 -right-20 w-96 h-96 rounded-full bg-primary-100/50 dark:bg-gray-800/50 blur-2xl" />
      <div className="absolute -top-10 -left-10 w-80 h-80 rounded-full bg-teal-100/50 dark:bg-gray-800/50 blur-2xl" />
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        <div className="relative z-10 flex flex-col justify-center px-12 text-gray-900 dark:text-white">
          ...
          <h2 className="text-5xl font-black mb-6 leading-tight">Welcome Back, Super Parent! 👋</h2>
          ...
          <div className="space-y-6">
            {['Real-time health monitoring', 'AI-powered recommendations', 'Vaccination schedule tracker', 'Community support'].map(f => (
              <div key={f} className="flex items-center gap-4">
                ...
                <span className="text-gray-600 dark:text-gray-300 text-lg font-medium">{f}</span>
              </div>
            ))}
          </div>
        </div>
