  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-primary-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        {/* Decorative circles */}
        <div className="absolute -bottom-20 -right-20 w-80 h-80 rounded-full bg-primary-50 dark:bg-gray-800/50" />
        <div className="absolute -top-10 -left-10 w-64 h-64 rounded-full bg-teal-50 dark:bg-gray-800/50" />
      </div>
